...
| Units U3–U6 | archmage_unique_units §13 | **Not started.** U3 next: stack-integrated trigger framework (R3), priority windows, auto-pass/stops + the Long Table keys (pack passive, Requiem, Deathburst) + conductor roster end-to-end. |
