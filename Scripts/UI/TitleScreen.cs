...
// TitleScreen.cs
//
// Purpose:        The launch screen (2026-08-21) — the ONE screen shown
//                 before the game routes anywhere. Cold boot used to
...
public partial class TitleScreen : Control
{
    ...
    /// <summary>Resume the most recent guild and land in the city hub — the same
