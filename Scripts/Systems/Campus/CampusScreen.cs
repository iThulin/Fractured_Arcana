...
public partial class CampusScreen : Control
{
    ...
    // renderers (WorldAtlas3D / ExpeditionWindow3D) graduated into the real strategic
    // scene and the live expedition overlay. The panel classes are retired with them.
